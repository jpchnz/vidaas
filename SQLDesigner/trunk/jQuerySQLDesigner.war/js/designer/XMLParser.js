...
function createAddTable(xCoordinate, yCoordinate, xmlTable, databaseObject, foreignKeysArrays){
    ...
    $(xmlTable).find("column").each(function(){
        ...
        tempInnerHTML = tableTemp.updateFunction(columnKeyType, columnValuesArray[1], columnValuesArray[2], columnValuesArray[3], 0, columnValuesArray[4], columnValuesArray[5], columnValuesArray[6]);
    });
