...
public class SystemVars {
	...
	public static final String ADDRESS_OF_IAM_WEBAPP_RECEIVER = "http://localhost:8081/iam/ReceivePost";;//"http://129.67.241.38/iam/ReceivePost";
	
	public static final String ADDRESS_OF_VIDAAS_BILLING_APP = "http://localhost:8081/vidaasBilling";//"http://129.67.103.124:8081/vidaasBilling";
